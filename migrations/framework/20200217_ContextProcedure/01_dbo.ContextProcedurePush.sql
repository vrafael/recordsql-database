...
--changeset vrafael:framework_20200217_ContextProcedure_01_dboContextProcedurePush logicalFilePath:path-independent splitStatements:true stripComments:false endDelimiter:\nGO runOnChange:true
SET ANSI_NULLS ON
...
BEGIN
    ...
    IF @position + 4 <= 128 -- пишем процу если помещаемся в контекст
    BEGIN
